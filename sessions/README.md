...
| Session | Headline |
|---|---|
| [2026-09-06](2026-09-06.md) | **CLEAR# and RESET# are floating on all four DACs** — the best explanation yet for the configuration loss, and a four-wire fix if confirmed. The 37 nA candidates ranked by impedance: contamination beats the floating shield. A new cheap test: the offset should scale with rail voltage if it is rail leakage |
