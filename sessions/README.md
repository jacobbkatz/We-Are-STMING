...
| Session | Headline |
|---|---|
| [2026-09-11](2026-09-11.md) | **Documentation only — nothing powered, nothing measured.** Answered the cleaning-kit question: **wipes and swabs are the step that actually removes the rosin** (IPA alone dissolves it and lets it dry back as a wider film), and **distilled water is downgraded to optional and possibly harmful** for this halide-free ROL0 flux — most of which `docs/PREAMP_SHOPPING_LIST.md` already had. **Recorded that we own IPA and brushes, grade and type UNKNOWN.** Folded **six bench items out of `2026-09-09-jacob.md` §9 into `docs/NEXT_SESSION_PLAN.md`**, where `CLAUDE.md` §6 says they belong — two new verification steps (C2's stripe, calipers on the 11301) and three do-nots. **New defect: `check_facts.py` does not check markdown link targets** — found by deliberately breaking one and watching it pass. No broken links exist today; the hole is in the guard |
