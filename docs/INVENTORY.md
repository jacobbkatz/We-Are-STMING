...
| **100 MΩ feedback resistor** | ≥1 | `SAID` | Value CONFIRMED. Not fitted to the board. **One is now the rebuilt preamp's feedback resistor (2026-09-15). Whether a SPARE of 100 MΩ or more exists is UNKNOWN** — asked 2026-09-16, not answered; the dummy junction test needs one |
