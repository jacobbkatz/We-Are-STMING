...
| **Print material** | The `.3mf` plates (2026-07-03) select **PA-CF** at 290 °C; `docs/BOM.md` §10 (2026-08-14) says "we used **PETG-CF**" | **Which the parts in hand actually are.** One question to whoever ran the printer. Stiffness, creep and moisture uptake all differ, and all three show up as image drift |
