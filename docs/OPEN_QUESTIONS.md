...
|---|---|
| **Is the scan head shield cover built, wrapped in copper and grounded?** | **A different shield from the preamp box.** `6_shield_cover.stl` drops over the whole scanning module. Its status has never been recorded anywhere. Berard: without the outer shield, images are dominated by 60 Hz pickup |
