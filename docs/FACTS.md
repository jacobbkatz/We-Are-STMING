...
| **11301 into our board hole** | **CONTRADICTED AT THE BENCH 2026-09-15 — DO NOT TREAT THE FIGURE BELOW AS FACT.** Jacob, part in hand: **"the standoff doesn't fit in the hole at all."** It did not enter. **Which of the two part numbers we own was in hand was not confirmed at the time of that reading**, and we own two 11311 as well, which are known not to fit. **Nothing has been drilled, forced or changed.** The claim below stands only if the part offered up was an 11301 and the hole was the Ø2.108 mm NPTH one; **until that is settled the fit is UNKNOWN** — see `docs/OPEN_QUESTIONS.md`. Original text follows. ~~**0.076 mm CLEARANCE. It drops in. Do NOT drill.**~~ **Corrected 2026-09-14, same day**, from Berard's own Eagle board in `We-Are-STMING_PCB.zip`: `<hole x="2.54" y="7.62" drill="2.1082"/>` — **he specifies 2.1082 mm for this exact part, and our board is 2.108 mm, identical to within 0.2 µm.** So the Eagle→KiCad conversion did **not** change this hole, and whatever enters it is ≤ 2.108 mm. The part's through-board pin is 0.080" = 2.032 mm, giving 0.076 mm of clearance. **0.086" (2.184 mm) is Keystone's RECOMMENDED clearance hole, not a requirement** — opening ours to it would only make the standoff looser | NETLIST + CALC | corrected 2026-09-14 |
