...
| Keystone **11301** turret head diameter | **Ø2.032 mm (0.080")** — **corrected 2026-09-14.** `docs/FACTS.md` previously implied 0.086" was the head; it is the mounting hole. 0.080" is the head **and** the below-board length | DIST | 2026-09-14 |
| **11301 into our board hole** | **0.076 mm interference** — 2.184 mm required against our 2.108 mm drilled, 3.6% of the hole. **A press fit, not a drop-in.** Remedy if it will not seat: open to a #44 drill (2.184 mm), which leaves 1.448 mm of edge margin. **Open the hole BEFORE the board is washed** — drilling after the wash puts fresh FR4 dust on the input node | CALC | 2026-09-14 |
